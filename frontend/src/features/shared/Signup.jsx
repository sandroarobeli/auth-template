...
import { selectUsername, selectStatus, selectError, signup, clearError } from '../../redux/userSlice'
...
const Signup = () => {
    ...
    const onSignUpClicked = async () => {
        if (userName && email && password && status === 'idle') {
            try {
    ...
    return (
        ...
        >
            <Typography variant='h4' component='h2'>Signup</Typography>
            <Box component="form">  
                <Stack spacing={2}>
                    <TextField
                        name='userName'
